...
const styles = StyleSheet.create({
  ...
  menuCard: { width: 220, borderRadius: 24, padding: 22, paddingVertical: 30, gap: 8, shadowColor: '#000', shadowOpacity: 0.12, shadowRadius: 20, elevation: 8 },
  menuItem: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 28, borderWidth: 1 },
